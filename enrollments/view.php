...
// Get student details
$student_stmt = $conn->prepare("SELECT fldstudentnumber, fldfirstname, fldlastname FROM tblstudent WHERE fldindex = ?");
...
<body>
  <div class="container">
    ...
    <main class="main-content">
      <a href="../enrollments/enrollment.php" class="back-button">← Back to Enrollment</a>
      ...
      <div class="student-header">
        ...
        <a href="download.php?id=<?= urlencode($student['fldstudentnumber']) ?>" class="form-button" target="_blank">Download PDF</a>
      </div>
